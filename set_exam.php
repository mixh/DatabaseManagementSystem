					...
					<div class="lbox">
						...
						<label> Select Semester</label><br>
							<select name="etype" required class="input3">
						       ...
						       <option value="I-Term">Even Semester</option>
						       <option value="II-Term">Odd Semester</option>
							</select>
					<br><br>
				...
				<div class="rbox">
					<label>Session</label>
						<select name="ses" required class="input3">
							<option value="">Select</option>
							<option value="FN">Current Sessions</option>
							<option value="AN">Precedding Sessions</option>
						</select>
					<br><br>
